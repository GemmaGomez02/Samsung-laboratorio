function validarNombre() {
    ...
    if (esValido) {
      ...
      nombreError.innerHTML = "Rellene este campo";
    }
  ...
  function validarCorreo() {
    ...
    if (esValido) {
      ...
      if (correoInput.value.trim().length == 0) {
        correoError.innerHTML = "Rellene este campo";
      } else {
        correoError.innerHTML = "Email inv&aacutelido";
      }
    }
  ...
  function validarContrasena() {
    ...
    var esValido = contrasenaInput.value.trim().length >= 1 && contrasenaInput.value.trim().length <= 8;
    if (esValido) {
      ...
      contrasenaError.innerHTML =
        "No debe tener m&aacutes de 8 caracteres";
    }
  ...
  function validarConfirmContrasena() {
    ...
    if (esValido) {
      ...
      contrasenaConfirmError.innerHTML = "Las contrase&ntildeas no coinciden";
    }
